 ...
 */
package zdenekskrobak.com.sunshine.data;
...
import zdenekskrobak.com.sunshine.data.WeatherContract.LocationEntry;
import zdenekskrobak.com.sunshine.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<Void, Void, Void> {
    ...
    public FetchWeatherTask(Context context, String location, Callback callback) {
        mContext = context;
        mLocation = location;
        mCallback = callback;
    }
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (cursor.moveToFirst()) {
            ...
            contentValues.put(LocationEntry.COLUMN_COORD_LON, lon);
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter("APPID", mContext.getString(R.string.weather_key))
                    .build();
        ...
        try {
            getWeatherDataFromJson(forecastJsonStr, mLocation);
        } catch (JSONException e) {
            Log.e(LOG_TAG, e.getMessage(), e);
            e.printStackTrace();
        }
